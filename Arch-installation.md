...
>## 5.Русифицируем систему: раскомментируем строчку с нужным языком.
...
FONT=cyr-sun16
```
Зададим имя (не путать с доменным) ПК:
